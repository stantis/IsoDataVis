...
Let's compare a simple carbon and nitrogen graph, with the sites color-coded. 
...
```
The first isn't *too* bad, especially not for intitial data exploration, but it's not ready for presentation.
