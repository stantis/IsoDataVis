...
library("viridis")
library("ggrepel")
#To read data directly from the github repo
library("repmis")
...
Here I'm going to explain the datavis rules that I follow to create stable isotopes graphs, along with the associated R code. I'm going to use bone collagen data (carbon, nitrogen, sulphur) and strontium from tooth enamel from my [PhD Thesis](https://ourarchive.otago.ac.nz/handle/10523/6019). These are bone samples from individuals excavated from two Polynesian sites, Bourewa (Fiji) and `Atele (Tonga). 
...
This is an early version (v 1.2), please let me know what I've missed either through Github or through [Twitter] () (@Chris.Stantis) if you want to see more isotopes-specific graphing in R. 
